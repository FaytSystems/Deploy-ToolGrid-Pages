export const SKELETON_TOOL_VERSION = "2026-06-13-generic-skeleton-tools-v6-next-frontier-expansion";
...
export function getSkeletonPatternForTool(tool) {
  if ((tool?.engine === "functional_tool" || tool?.engine === "mini_app") && tool.config?.skeletonPattern?.id) return tool.config.skeletonPattern;
