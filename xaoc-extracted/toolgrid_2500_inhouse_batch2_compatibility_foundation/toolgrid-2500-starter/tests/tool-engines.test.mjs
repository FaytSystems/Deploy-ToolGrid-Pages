...
assert.equal(IN_HOUSE_TOOLS_VERSION, "2026-06-13-in-house-tools-compatibility-v2-batch2");
assert.equal(IN_HOUSE_TOOL_RECORDS.length, IN_HOUSE_TOOL_TARGET_COUNT, "in-house starter suite should ship with the full batch-two tool count");
...
console.log("All ToolGrid 2500 in-house compatibility foundation tests passed.");
