...
const baseRuntimeForSkeletons = [...tools, ...IN_HOUSE_TOOL_RECORDS, WEBCAM_EXPLORER_TOOL, FACTCHECKER_TOOL, THEME_STUDIO_TOOL, RGB_GENERATOR_TOOL, RGB_MOTION_STUDIO_TOOL];
...
assert.equal(IN_HOUSE_TOOLS_VERSION, "2026-06-13-in-house-tools-compatibility-v8-batch8");
assert.equal(IN_HOUSE_TOOL_RECORDS.length, IN_HOUSE_TOOL_TARGET_COUNT, "in-house starter suite should ship with the full batch-eight tool count");
...
assert.equal(SKELETON_TOOL_VERSION, "2026-06-13-generic-skeleton-tools-v1");
...
console.log("All ToolGrid 2500 RGB Motion Studio foundation tests passed.");
process.exit(0);
