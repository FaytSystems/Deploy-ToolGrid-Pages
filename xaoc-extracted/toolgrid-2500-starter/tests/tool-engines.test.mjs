...
assert.equal(PROJECT_FOUNDATION_VERSION, "2026-06-13-prompt-compiler-foundation-v4");
...
console.log("All ToolGrid 2500 demand-ranked project foundation tests passed.");
